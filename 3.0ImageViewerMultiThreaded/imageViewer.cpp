...
ImageViewer::ImageViewer(QWidget *parent)
     : QWidget(parent)
 {
     ...
     image = new QLabel;
     image->setText(tr("Image here"));

     QImage myImage;
     myImage.load("image.png");
     ...
     this->setStyleSheet("background-color: #cecbaf;");
 ...
 void ImageViewer::loadFromFile()
 {
     ...
     if (fileName.isEmpty())
         ...
         std::cout << "\nFilename is: " << fileName.toStdString() << std::endl;
         QImage myImage;
